/*
The code in the file can be dropped into another project and used to determine an AWS instances public
ip address. This can be supplied, pulled from a remote url or looked up in instance metadata
...
// uncomment if you want to test complie the file
//func main() {}
